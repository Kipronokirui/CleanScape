...
export default function Navbar() {
  ...
  return (
    <header
      className="flex shadow-md py-4 px-4 sm:px-10 bg-white font-sans min-h-[70px] 
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-4 w-full">
        ...
        <div
          id="collapseMenu"
          className={`${
            modalOpen ? "lg:!block" : "max-lg:hidden"
        ...
        >
          ...
          <ul
            className="lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white 
          ...
          >
            ...
            <li className="max-lg:border-b max-lg:py-3 px-3">
              <a
                href="/"
                className="hover:text-[#007bff] text-[#007bff] font-bold block 
                                text-base"
              >
                Home
              </a>
        ...
        <div className="flex items-center max-lg:ml-auto space-x-5">
          <a href="/cart" className="relative">
            ...
            <span
              className={`absolute left-auto -ml-1 top-0 rounded-full bg-red-500 px-1 
                            py-0 text-xs text-white`}
            >
              0
            </span>
          </a>
